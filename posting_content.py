...
params['media_url'] = 'https://i.postimg.cc/1zmbdx6X/meme.jpg'  # url on public server for the post
params[
    'caption'] = 'This image was posted through the Instagram Graph API with a python script I wrote!'
# params['caption'] += "\n."
# params['caption'] += "\nyoutube.com/justinstolpe"
# params['caption'] += "\n."
params[
    'caption'] += "\n#instagram #graphapi #instagramgraphapi"  # caption for the post
...
params['media_url'] = 'https://thumbsnap.com/i/SPKZy7GJ.mp4'  # url on public server for the post
params[
    'caption'] = 'This video was posted through the Instagram Graph API with a python script I wrote!'
# params['caption'] += "\n."
# params['caption'] += "\nyoutube.com/justinstolpe"
# params['caption'] += "\n."
params[
